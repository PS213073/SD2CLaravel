...
@section('content')
    ...
    <div class="max-w-4xl mx-auto mt-8">
        ...
        <div class="flex justify-end mt-10">
            <a href="{{ route('post.create') }}" class="px-2 py-1 rounded-md bg-blue-500 text-sky-100 hover:bg-blue-700">+ Create New Post</a>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <form action="{{ route('post.destroy',$post->id) }}" method="POST">
                                        ...
                                        <a class="text-indigo-600 hover:text-indigo-900" href="{{ route('post.show',$post->id) }}">
                                        ...
                                        <a href="{{ route('post.edit',$post->id) }}" class="text-indigo-600 hover:text-indigo-900">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
