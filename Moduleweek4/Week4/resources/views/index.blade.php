...
<div class="max-w-4xl mx-auto mt-8">
    ...
    <div class="mb-4">
        <h1 class="text-3xl font-bold text-center">
            Laravel 9 CRUD With Tailwind CSS Songs
        </h1>
    </div>

    {{-- <div class="flex justify-end mt-10">
        <a href="{{ route('create') }}" class="px-2 py-1 rounded-md bg-blue-500 text-sky-100 hover:bg-blue-700">+ Create New Song</a>
    </div> --}}
                 ...
                 <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr>
                          ...
                          <a href="{{ route('show',$songs->id) }}" class="cursor-pointer"><td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $songs }}</td></a>
                            {{-- <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200"> --}}
                                {{-- <form action=" " method="POST"> --}}
                    
                                    {{-- <a class="text-indigo-600 hover:text-indigo-900" href="{{ route('show',$song->id) }}">
                                     ...
                                     --}}
                                    {{-- <a href="{{ route('edit',$song->id) }}" class="text-indigo-600 hover:text-indigo-900">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
